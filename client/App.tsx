...
const SDKIntegration = React.lazy(
...
// 🎯 特性页面懒加载
const AIMarketingFeature = React.lazy(
  () => import("./pages/features/AIMarketingOptimized"),
);
const UserProfilingFeature = React.lazy(
  () => import("./pages/features/UserProfiling"),
);
const RealTimeMonitoringFeature = React.lazy(
  () => import("./pages/features/RealTimeMonitoring"),
);
const EffectTrackingFeature = React.lazy(
  () => import("./pages/features/EffectTrackingOptimized"),
);

// 🎯 解决方案页面懒加载
const EcommerceSolution = React.lazy(
  () => import("./pages/solutions/EcommerceSolution"),
);
const ContentSolution = React.lazy(
  () => import("./pages/solutions/ContentSolution"),
);
const FinancialSolution = React.lazy(
  () => import("./pages/solutions/FinancialSolution"),
);
const EnterpriseSolution = React.lazy(
...
const AppContent: React.FC = () => {
  const { isOpen, closeModal, modalTitle, modalDescription } =
    useContactModal();
