...
export const COMPONENT_VARIANTS = {
  ...
  button: {
    intent: {
      ...
      secondary: "bg-secondary hover:bg-secondary-hover text-secondary-foreground border border-border",
...
export function createVariants<T extends Record<string, Record<string, string>>>(
  ...
  return function(props: { [K in keyof T]?: keyof T[K] } & { className?: string }) {
