...
const NewEventsCopy = React.lazy(() => import("@/pages/NewEventsCopy"));
...
const RuleList = React.lazy(() => import("@/pages/MappingRules/RuleList"));
const RuleDetail = React.lazy(() => import("@/pages/MappingRules/RuleDetail"));

const RuleList2 = React.lazy(() => import("@/pages/MappingRules2/RuleList"));
const RuleDetail2 = React.lazy(() => import("@/pages/MappingRules2/RuleDetail"));

const DecisionExecutionPage = React.lazy(() => import("@/pages/Decision/DecisionExecutionPage"));
const ExecutionResultPage = React.lazy(() => import("@/pages/Decision/ExecutionResultPage"));

const AITemplateList = React.lazy(() => import("@/pages/AITemplates/AITemplateList"));
const AITemplateDetail = React.lazy(() => import("@/pages/AITemplates/AITemplateDetail"));
...
export const staticRoutes: RouteObject[] = [
  ...
  {
    path: "/decision/:decisionId/execution",
    element: (
      <Layout>
        <LazyRoute>
  ...
  {
    path: "/decision/:decisionId/execution/:executionId/result",
    element: (
      <Layout>
        <LazyRoute>
          <ExecutionResultPage />
