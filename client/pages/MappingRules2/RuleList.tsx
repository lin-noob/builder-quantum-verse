  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">映射与识别规则配置</h1>
          <p className="text-muted-foreground mt-1">
            这里配置事件如何触发对象实例和 AI 分析
          </p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Button onClick={() => navigate('/mapping-rules-2/new')} className="flex items-center gap-2">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="text-sm text-blue-800">
          ...
          <p className="mt-1">选择规则后，可在详情页选择 AI 分析模板和开关，无需关心内部字段或逻辑。</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredRules.map((rule) => (
          <Card 
            ...
            onClick={() => navigate(`/mapping-rules-2/${rule.id}`)}
          >
