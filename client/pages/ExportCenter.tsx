...
export default function ExportCenter() {
  ...
  // 获取状态标签样式
  const getStatusBadgeVariant = (status: ExportTask['status']) => {
    switch (status) {
      case 'success':
        return 'default';
      case 'processing':
  ...
  // 筛选任务
  const filteredTasks = mockExportTasks.filter(task => {
    const matchesSearch = 
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-full">
      <div className="max-w-none">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 mt-1">管理所有数据导出任务</p>
        </div>
        ...
        <Card className="p-6 mb-8 bg-white shadow-sm">
          <div className="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div className="flex items-end gap-2">
              ...
              <Button
                onClick={handleCreateExportTask}
                className="flex items-center gap-2 h-10"
              >
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="px-6 py-4">导出内容</TableHead>
                ...
                {currentTasks.length === 0 ? (
                  ...
                  currentTasks.map((task) => (
                    <TableRow key={task.id} className="hover:bg-gray-50">
                      ...
                      <TableCell className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          {task.fileSize ? formatFileSize(task.fileSize) : "N/A"}
                        </div>
                      </TableCell>
                      <TableCell className="px-6 py-4">
