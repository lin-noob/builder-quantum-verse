        ...
        {selectedEventId && selectedEvent ? (
          <div className="p-3 space-y-3 pb-20">
            ...
            <CollapsibleLayer
              ...
              summary={
                <div className="flex gap-2">
                  <span className="px-1.5 py-0.5 rounded text-[10px] bg-blue-50 text-blue-600 border border-blue-100 font-medium">邮件: 询价 (98%)</span>
                  <span className="px-1.5 py-0.5 rounded text-[10px] bg-slate-100 text-slate-600 border border-slate-200">行为: 3次关键动作</span>
                  <span className="px-1.5 py-0.5 rounded text-[10px] bg-orange-50 text-orange-600 border border-orange-100 font-medium">风险: 高</span>
                </div>
              }
              className="mb-2"
            >
            ...
            <CollapsibleLayer
              ...
              summary={
                <span>状态: <span className="text-purple-600 font-medium">人工已修订</span> · 3条局势判断 · 2条行动目标</span>
              }
              className="mb-2"
            >
         ...
         {selectedEventId && selectedEvent && (
            <StickyActionBar 
              ...
              onAction={(newStatus) => setDecisionStatus(newStatus)}
            />
         )}
      </div>
    </div>
