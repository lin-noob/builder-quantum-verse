...
const RelationGraphEditor: React.FC<RelationGraphEditorProps> = ({
  ...
  useEffect(() => {
    ...
    setEdges(relEdges);
  }, [relations, currentId, currentName, readOnly, availableTypes]);
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-start-2 col-span-3 text-[10px] text-slate-400 -mt-2">该关系将从此对象类型出发</div>
            </div>

            {/* 2. Target Object Type (Select) */}
            <div className="grid grid-cols-4 items-center gap-4">
              <Label className="text-right">
                目标对象类型 <span className="text-red-500">*</span>
              </Label>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label className="text-right">
                关系语义 <span className="text-red-500">*</span>
              </Label>
              <div className="col-span-3">
                <Input
                ...
                />
                <div className="text-[10px] text-slate-400 mt-1">大写英文，下划线分隔。例如：CONTAINS, BELONGS_TO</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label className="text-right">
                关系方向 <span className="text-red-500">*</span>
              </Label>
              <div className="col-span-3">
                <Select
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                ...
                />
                <div className="text-[10px] text-slate-400 mt-1">表示该关系通常由哪个业务动作产生</div>
              </div>
            </div>
          </div>
          <DialogFooter>
