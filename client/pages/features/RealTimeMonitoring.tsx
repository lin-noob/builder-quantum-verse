  ...
  const features = [
    {
      ...
      title: "实时数据监控",
      description: "24/7实时监控营销活动数据，毫秒级响应数据变化，确保营销效果可视化",
      benefits: ["实时数据同步", "多维度指标监控", "可视化数据展示", "历史趋势对比"]
    },
    {
      icon: <AlertTriangle className="h-8 w-8 text-red-600" />,
      title: "智能异常预警",
      description: "基于机器学习的异常检测算法，主动识别营销异常并及时预警通知",
      benefits: ["异常行为识别", "阈值智能设定", "多渠道预警通知", "预警策略配置"]
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">监控指标体系</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">智能预警机制</h2>
                ...
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="flex items-center">
                      {alert.icon}
                      <div className="ml-4">
                        <h3 className="text-xl font-semibold text-gray-900 mb-2">{alert.type}</h3>
                        <p className="text-gray-600">{alert.description}</p>
                      </div>
                    </div>
                    <div>
                      <h4 className="text-lg font-medium text-purple-600 mb-3">自动响应策略</h4>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-purple-600 font-medium">即时通知</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">技术特性</h2>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">监控能力</h3>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 mb-2">1000万+</div>
                  <div className="text-gray-600">日处理事件</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 mb-2">7x24</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-800 rounded-2xl p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-gray-700 rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-blue-400 mb-2">1,245</div>
