...
const features = [
  {
    ...
    title: "全链路追踪",
    description:
      "从用户触点到最终转化，全程跟踪用户行为路径，量化每个环节的效果贡献",
    benefits: [
      "多触点归因分析",
      "转化路径追踪",
      "渠道效果对比",
  ...
  return (
    <section className="py-20 bg-red-600">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-red-100 mb-8">让数据驱动您的营销决策</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            size="lg"
            className="bg-white text-red-600 border-2 border-white hover:bg-red-50 hover:text-red-700 text-lg px-8 py-4 font-bold shadow-lg"
          >
            预约产品演示
          </Button>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="space-y-3">
                {["转化率", "ROI/ROAS", "客户获取成本", "生命周期价值"].map(
                  (metric, index) => (
