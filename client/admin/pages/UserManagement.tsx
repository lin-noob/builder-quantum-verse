      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">正常状态用户</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">已禁���账户</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">等待激活用户</p>
          </CardContent>
        </Card>
      </div>
          ...
          {totalPages > 1 && (
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t">
              <div className="text-sm text-gray-700 order-2 sm:order-1">
                正在显示 {startIndex + 1} -{" "}
                {Math.min(endIndex, filteredUsers.length)} 条，共{" "}
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveNewUser}>创建用户</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
