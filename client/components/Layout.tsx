              ...
              <ul className="space-y-2">
                {menuItems.map((item) => {
                  const isActive =
                    ...
                    (item.id === "sdk-integration" &&
                      location.pathname.startsWith("/integration/sdk")) ||
                    (item.id === "admin" &&
