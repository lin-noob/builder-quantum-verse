...
interface CollapsibleLayerProps {
  ...
  status?: "default" | "locked" | "completed" | "active" | "blocked";
  className?: string;
}
  ...
  return (
    <div className={cn("group relative pl-8", className)}>
      ...
      <div className={cn(
        ...
        status === "completed" ? "bg-purple-200" : 
        status === "blocked" ? "bg-red-200" : "bg-slate-200",
      ...
      <div 
        className={cn(
          ...
          status === "blocked" ? "bg-white border-red-500 text-red-500" :
      ...
      <Card className={cn(
        ...
        <div 
          ...
          className={cn(
            "transition-[height] duration-300 ease-in-out bg-white",
            isFullyOpen ? "overflow-visible" : "overflow-hidden"
          )}
        >
