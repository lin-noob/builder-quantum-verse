...
const DEFAULT_STATE: DecisionTraceState = {
  ...
  dataPreparation: {
    requirements: [
      ...
      { id: 'r2', goalId: 'g2', objectType: 'LogisticsProvider', fields: ['delivery_sla'], relations: ['shipping_routes'] },
  ...
  reasoning: {
    ...
    results: [
      ...
      },
      {
        ...
        inferences: [
          { id: 'i2', text: '预计 2月13日 前送达', logic: 'Today + 3 days < Feb 14', confidence: 0.85, dependentFacts: ['f3'] }
        ],
        risks: [
          { id: 'r1', triggerCondition: '海关查验', impact: '延迟 2-3 天', probability: 'Low (15%)' }
        ],
        uncertainties: ['客户具体收货地址未确认 (影响精确时效)']
      },
      {
        goalId: 'g3',
        status: 'PENDING',
        facts: [
          { id: 'f5', text: '标准合同包含 1 年基础保修', confidence: 1.0, source: 'ContractTemplate(tpl_standard).warranty_clause' }
        ],
        inferences: [
          { id: 'i3', text: '客户要求的"延长保修"需额外购买', logic: 'Standard != Extended', confidence: 0.95, dependentFacts: ['f5'] }
        ],
        risks: [],
        uncertainties: []
      }
...
const MOCK_STATES: Record<string, DecisionTraceState> = {
  ...
  'evt_004': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '确认 VIP 库存预留', initialSuggestion: '检查 VIP 专属库存池', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '安排极速物流', initialSuggestion: '调用专车配送服务', isConfirmed: true, isEnabled: true },
        { id: 'g3', description: '生成加急订单', initialSuggestion: '创建优先等级 1 订单', isConfirmed: true, isEnabled: true }
      ],
      status: 'pending'
    },
    dataPreparation: {
        ...
        candidates: [
            { id: 'prod_s2', goalId: 'g1', name: 'Quantum S2', type: 'Product', isSelected: true, data: { vip_stock: 500 }, missingFields: [] },
            { id: 'log_special', goalId: 'g2', name: '专车配送', type: 'LogisticsProvider', isSelected: true, data: { speed: '4小时' }, missingFields: [] }
        ],
        integrityIssues: []
    }
  },
  ...
  'evt_005': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '识别关注痛点', initialSuggestion: '分析浏览热力图', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '推送差异化优势材料', initialSuggestion: '发送《为什么选择 Quantum》邮件', isConfirmed: true, isEnabled: true }
      ],
      status: 'pending'
    }
  },
  ...
  'evt_006': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '评估信用风险', initialSuggestion: '查询历史回款记录', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '决定订单处理方式', initialSuggestion: '暂时挂起订单或申请特批', isConfirmed: true, isEnabled: true }
      ],
      status: 'pending'
    },
    reasoning: {
        ...
        results: [
            {
                ...
                inferences: [
                    { id: 'i1', text: '信用记录良好，属业务扩张导致的临时额度紧张', logic: 'History == Good', confidence: 0.9, dependentFacts: ['f2'] }
                ],
                risks: [
                    { id: 'r1', triggerCondition: '超额度发货', impact: '坏账风险增加', probability: 'Medium' }
                ],
                uncertainties: []
            }
        ]
  ...
  'evt_007': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '发起续约流程', initialSuggestion: '生成续约合同草稿', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '预约续约谈判会议', initialSuggestion: '发送会议邀请', isConfirmed: true, isEnabled: true }
      ],
      status: 'completed'
    },
    result: {
  ...
  'evt_008': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '安抚客户情绪', initialSuggestion: '发送道歉信并承诺 24h 内给出方案', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '启动质量调查', initialSuggestion: '创建 QA Ticket 并通知质量部', isConfirmed: true, isEnabled: true },
   ...
   'evt_009': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '评估线索质量', initialSuggestion: '根据公司规模和行业打分', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '发送后续资料', initialSuggestion: '发送相关案例研究', isConfirmed: true, isEnabled: true }
      ],
      status: 'pending'
    }
  },
  ...
  'evt_010': {
    ...
    intentAnalysis: {
      ...
      isModified: false,
      goals: [
        { id: 'g1', description: '临时冻结账户', initialSuggestion: '执行账户锁定操作', isConfirmed: true, isEnabled: true },
        { id: 'g2', description: '通知客户管理员', initialSuggestion: '发送安全警告邮件/短信', isConfirmed: true, isEnabled: true }
      ],
      status: 'completed'
    },
    result: {
