...
export const predefinedScenarios: MarketingScenario[] = [
  {
    ...
    defaultAIConfig: {
      ...
      description:
        "AI��根据用户画像、购物车商品等信息，自主生成最合适的挽留或激励文案",
      ...
      dimensions: [
        ...
        },
        {
          ...
          strategy: '采用"智能延迟"',
          reasoning:
            "AI不会在用户加购的瞬间立即打扰，而是会持续分析后续行为。只有当用户表现出离开意图（如鼠标快速移向关闭按钮）或长时间无操作时，才会触发。",
          examples: [
        ...
        },
        {
          ...
          strategy: '进行"个性化生成"',
          reasoning:
            "AI会基于触发用户的画像和购物车内容，动态生成最合适的挽留文案。",
          examples: [
      ...
      dimensions: [
        {
          ...
          strategy: '优先使用"网页弹窗"',
          reasoning:
            '与"加入购物车"场景类似，实时性是关键。AI会选择最适合在当前页面进行即时互动的网页弹窗。',
          examples: [
        ...
        },
        {
          ...
          strategy: '采用"智能延迟"',
          reasoning:
            "AI会基于用户的投入度来决策。核心信号是页面停留时长和滚动深度。",
          examples: [
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        "AI会根据用户注册前的浏览行为和来源渠道，生成个性化的欢迎和引导内容",
      ...
      dimensions: [
        {
          ...
          strategy: '采用"组合拳"',
          reasoning:
            "AI会结合使用多种方式。首先通过网页弹窗给予即时反馈，然后在短时间内通过发送邮件提供更详细的引导，以覆盖不同场景。",
          examples: [
        ...
        },
        {
          ...
          strategy: '"立即触发"为主',
          reasoning:
            '用户的注册行为是一个明确的"里程碑"事件，需要立即给予积极的反馈和引导，以巩固用户关系。',
          examples: [
        ...
        },
        {
          ...
          strategy: '进行"兴趣引导"',
          reasoning:
            "AI会分析该用户在注册前的匿名浏览行为，将这些兴趣点融入到欢迎内容中。",
          examples: [
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        "AI会根据用户的分层、距上次购买时间等，生成不同类型的个性化问候",
      ...
      dimensions: [
        {
          ...
          strategy: '优先使用"网页弹窗"',
          reasoning:
            '登录是一个关键的身份确认节点，AI会优先使用网页弹窗来传递最直接、最个性化的"欢迎回来"信息。',
          examples: [
        ...
        },
        {
          ...
          strategy: '进行"身份感知生成"',
          reasoning:
            "AI会深度分析用户的历史数据，生成最符合其当前状态的沟通内容。",
          examples: [
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        'AI会分析用户画像，决策是提供"免运费"等小激励，还是用"社会认同"（如"已有XXX人购买"）来增强其购买信心。',
      strategySummary:
        "在用户于结账页停留过久或准备离开时触发，提升最终转化率。",
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        "AI会根据本次购买的商品，智能推荐关联配件或消耗品，并生成个性化的感谢与交叉销售邮件。",
      strategySummary:
        "立即感谢并确认订单，通过智能延迟推荐关联商品，提升复购率。",
      ...
      dimensions: [
        {
          ...
          strategy: '优先使用"发送邮件"',
          reasoning:
            "购买完成后，邮件是最合适的跟进方式，既能确认订单又能进行后续营销。",
          examples: [
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        "AI会分析搜索关键词。如果匹配到热门商品或活动，会立即生成一个包含相关商品链接的推荐弹窗；如果搜索结果为空，则会生成引导用户联系客服或浏览相关品类的弹窗。",
      ...
      dimensions: [
        {
          ...
          strategy: '优先使用"网页弹窗"',
          reasoning:
            "搜索是用户主动表达需求的行为，需要立即在搜索结果页提供相关引导。",
          examples: [
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        'AI会根据用户准备离开的页面和用户身份，进行场景化挽留。例如，在博客页离开时推荐订阅，在定价页离开时提供限时优惠，对新用户则弹出"首次下单立减"的通用挽留。',
  ...
  },
  {
    ...
    defaultAIConfig: {
      ...
      contentStrategy: "FULLY_GENERATIVE",
      description:
        'AI会根据表单名称（如"产品演示申请"），自动生成一封专业的确认邮件，告���用户后续流程，并根据其公司、职位等信息，附上最相关的案例或白皮书。',
...
// 获取单个营销场景
export const getMarketingScenario = (
  scenarioId: string,
): Promise<MarketingScenario | null> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const updateMarketingScenario = (
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      const index = predefinedScenarios.findIndex(
        (s) => s.scenarioId === scenarioId,
      );
      if (index !== -1) {
        predefinedScenarios[index] = {
          ...predefinedScenarios[index],
          ...updates,
        };
        resolve(true);
...
// 添加自定义规则
export const addOverrideRule = (
  scenarioId: string,
  rule: Omit<OverrideRule, "ruleId" | "createdAt" | "updatedAt">,
): Promise<string> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      const scenario = predefinedScenarios.find(
...
// 更新自定义规则
export const updateOverrideRule = (
  scenarioId: string,
  ruleId: string,
  updates: Partial<OverrideRule>,
): Promise<boolean> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      const scenario = predefinedScenarios.find(
      ...
      if (scenario) {
        const ruleIndex = scenario.overrideRules.findIndex(
          (r) => r.ruleId === ruleId,
        );
        if (ruleIndex !== -1) {
...
// 删除自定义规则
export const deleteOverrideRule = (
  scenarioId: string,
  ruleId: string,
): Promise<boolean> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      if (scenario) {
        ...
        scenario.overrideRules = scenario.overrideRules.filter(
          (r) => r.ruleId !== ruleId,
        );
