  ...
  orders: [
    {
      ...
      payment: "支付宝",
      items: [
        { name: "ProBook X1", price: 1599.0, qty: 1, total: 1599.0 },
        { name: "无线鼠标", price: 300.0, qty: 1, total: 300.0 },
      ],
    },
    {
      id: "ORD-20250615-005",
...
export const fetchUserDetail = async (
  ...
  const dynamicUserDetail: UserDetailResponse = {
    ...
    kpis: {
      ...mockUserDetail.kpis,
      totalSpend: user
        ? `¥${user.totalSpend.toLocaleString("zh-CN", { minimumFractionDigits: 2 })}`
        : "¥0.00",
